...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: 'Remember to update Emma Davis\'s medication schedule',
    time: '5:45 PM',
    date: 'Yesterday',
    read: true,
    type: 'reminder',
  },
  {
    ...
    message: 'A new patient record has been created for Robert Brown',
    time: '3:20 PM',
    date: 'Yesterday',
    read: true,
    type: 'update',
  },
  {
    ...
    message: 'Your 2:00 PM appointment with James Miller has been cancelled',
    time: '1:15 PM',
    date: 'Yesterday',
    read: true,
    type: 'appointment',
  },
  {
    ...
    message: 'New lab results are available for patient Jennifer Clark',
    time: '11:30 AM',
    date: '2 days ago',
    read: true,
    type: 'update',
      ...
      <View style={styles.actionBar}>
        ...
        >
          <Text style={[
            ...
            notifications.length === 0 && styles.disabledButtonText
          ]}>
            Clear All
          </Text>
        </TouchableOpacity>
